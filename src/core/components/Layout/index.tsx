...
export default function Layout(props: any) {
    ...
    const rightItems = [
        ...
        },
        {
            ...
            key: 'panel',
            children: <Collapse activeKey={"Typography"}>
                {/*<Panel header="Layout" key="Index">*/}
                {/*    <LayoutPanel/>*/}
                {/*</Panel>*/}
    ...
    return (
        <div className={"w-full h-screen bg-white"}>
            <div
                className={"w-full h-[50px] flex items-center px-[16px] border-b-[1px] border-b-gray-200"}>
                <h1>REM</h1>
                <div className={"h-full flex-1"}>
                    <Tabs centered className={"rem-device-tab"} defaultActiveKey="1" items={deviceList}/>
                </div>
                <div>
            ...
            <div className={"flex"}>
                <div className={"h-[calc(100vh_-_50px)] w-[370px] border-r-[1px] border-b-gray-200"}>
                    <Tabs className={"rem-device-tab border-b-[1px] border-b-gray-200"} defaultActiveKey="Layers"
                          items={leftItems}/>
                </div>
                <div className={"h-[calc(100vh_-_50px)] w-[calc(100%_-_727px)]"}>
                    <Content>{props.children}</Content>
                </div>
                <div className={"h-[calc(100vh_-_50px)] w-[357px] border-l-[1px] border-b-gray-200"}>
                    <Tabs
